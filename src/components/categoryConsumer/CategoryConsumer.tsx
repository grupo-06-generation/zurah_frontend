            ...
            <div className="flex justify-center items-center flex-wrap mb-24">
                ...
                <div className="w-[1400px] h-[200px] flex flex-row justify-between items-center mt-4">
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <h2 className='text-[14px] py-4 font-semibold text-olive'>OFERTAS</h2>
                    </div>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <h2 className='text-[14px] py-4 font-semibold text-olive'>ORGÂNICOS</h2>
                    </div>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <h2 className='text-[14px] py-4 font-semibold text-olive'>HORTIFRUTI</h2>
                    </div>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <h2 className='text-[14px] py-4 font-semibold text-olive'>CEREAIS</h2>
                    </div>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <h2 className='text-[14px] py-4 font-semibold text-olive'>FRIOS, QUEIJOS E<br /> 
                            LATICÍNIOS</h2>
                    </div>
