    ...
    <div className="flex items-center justify-center min-h-[80vh] p-12 bg-gray-100">
      <div className="flex bg-white rounded-lg shadow-lg overflow-hidden w-full sm:w-3/4">
        ...
        <div className="w-full p-8 lg:w-1/2">
          <h2 className="text-6xl font-semibold text-green-900 text-center">
            Zurah
          </h2>
          ...
          <form action="" onSubmit={login}>
            ...
            <div className="flex justify-between mt-3">
              ...
              <a
                href="#"
                className="text-xs text-green-900 hover:text-green-500"
              >
                Esqueceu a senha?
              </a>
            </div>
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <Link
              to={"/register"}
              className="text-xs text-green-900 hover:text-green-500 uppercase"
            >
              Ou Cadastrar-se
            </Link>
            <span className="border-b w-1/5 md:w-1/4"></span>
